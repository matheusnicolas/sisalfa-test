	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<a href="cadastrarContexto.jsp"><button class="btn btn-primary navbar-btn">Cadastrar Desafio</button></a>
				<a href="tabela.jsp"><button class="btn btn-primary navbar-btn">Listar Desafios</button></a>
